                    ...
                    <div className="bg-bg-elevated rounded-xl sm:rounded-2xl border border-white/10 p-5 sm:p-6 md:p-8 max-w-md w-full shadow-2xl">
                        ...
                        {verificationResult?.verified ? (
                            ...
                            <>
                                ...
                                {/* Contact CTA — for new (unverified) prospects who want to talk through
                                    their project first. Routes to the portfolio's Get-in-touch / booking form. */}
                                <div className="mt-4 sm:mt-5 pt-4 sm:pt-5 border-t border-white/10">
                                    <p className="text-center text-[10px] sm:text-xs text-text-muted mb-2 sm:mb-3">
                                        Prefer to talk through your project first? Reach out and we&apos;ll scope it together.
                                    </p>
                                    <Link
                                        href="/#contact"
